...
import type { QuoteFormData, EmailServiceResponse } from '@/types';
...
export const sendQuoteRequest = async (formData: QuoteFormData): Promise<EmailServiceResponse> => {
  try {
...
const formatQuoteRequestMessage = (formData: QuoteFormData): string => {
...
const sendViaMailto = async (formData: QuoteFormData): Promise<EmailServiceResponse> => {
