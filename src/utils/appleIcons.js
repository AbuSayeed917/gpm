...
export const AppleIconCategories = {
  ...
  communication: [
    'Message', 'Mail', 'Phone', 'VideoCall', 'Chat', 'Forum', 'ContactSupport',
    'Contacts', 'PersonAdd', 'Group', 'Share', 'Reply', 'Forward', 'Send'
  ],
  
  // Media & Entertainment  
  media: [
    'PlayArrow', 'Pause', 'Stop', 'SkipNext', 'SkipPrevious', 'Repeat', 'Shuffle',
    'VolumeUp', 'VolumeOff', 'Photo', 'Camera', 'Videocam', 'Movie', 'Music',
    'Album', 'Queue', 'LibraryMusic', 'PhotoLibrary', 'Collections'
  ],
  
  // Navigation & Actions
  navigation: [
    'ArrowForward', 'ArrowBack', 'ArrowUpward', 'ArrowDownward', 'ArrowLeft', 
    'ArrowRight', 'KeyboardArrowUp', 'KeyboardArrowDown', 'ExpandMore', 'ExpandLess',
    'ChevronLeft', 'ChevronRight', 'FirstPage', 'LastPage', 'Home', 'Menu', 'Close'
  ],
  
  // System & Settings
  system: [
    'Settings', 'Tune', 'Build', 'Code', 'Storage', 'Memory', 'Speed', 'Security',
    'Lock', 'LockOpen', 'Visibility', 'VisibilityOff', 'Shield', 'Admin', 'Key',
    'Fingerprint', 'Password', 'VpnKey', 'Update', 'Sync', 'Refresh'
  ],
  
  // Content & Editing
  content: [
    'Add', 'Remove', 'Edit', 'Delete', 'Save', 'SaveAs', 'Copy', 'Cut', 'Paste',
    'Undo', 'Redo', 'Search', 'FilterList', 'Sort', 'Clear', 'SelectAll',
    'Deselect', 'Check', 'CheckBox', 'RadioButton', 'ToggleOn', 'ToggleOff'
  ],
  
  // File & Cloud
  files: [
    'Folder', 'FolderOpen', 'FolderSpecial', 'InsertDriveFile', 'Description',
    'PictureAsPdf', 'TextSnippet', 'Cloud', 'CloudDownload', 'CloudUpload',
    'CloudSync', 'Backup', 'Archive', 'Unarchive', 'AttachFile', 'Link'
  ],
  
  // Business & Finance
  business: [
    'Business', 'Work', 'AccountBalance', 'Payment', 'CreditCard', 'MonetizationOn',
    'TrendingUp', 'TrendingDown', 'Analytics', 'Assessment', 'BarChart', 'PieChart',
    'Timeline', 'ShowChart', 'Insights', 'Receipt', 'ShoppingCart', 'Store'
  ],
  
  // Health & Wellness
  health: [
    'Favorite', 'FavoriteBorder', 'MonitorHeart', 'Psychology', 'SelfImprovement',
    'DirectionsRun', 'FitnessCenter', 'Pool', 'Sports', 'LocalHospital',
    'Medication', 'Healing', 'EmergencyShare', 'HealthAndSafety'
  ],
  
  // Transportation
  transport: [
    'DirectionsCar', 'DirectionsBike', 'DirectionsWalk', 'DirectionsBus',
    'DirectionsSubway', 'Flight', 'Train', 'LocalShipping', 'Navigation',
    'GpsFixed', 'LocationOn', 'LocationOff', 'MyLocation', 'Explore', 'Map'
  ],
  
  // Weather & Nature
  weather: [
    'WbSunny', 'NightsStay', 'Cloud', 'CloudQueue', 'Thunderstorm', 'AcUnit',
    'Umbrella', 'Waves', 'Terrain', 'Park', 'Forest', 'Eco', 'Energy',
    'WaterDrop', 'Air', 'WindPower', 'Solar'
  ],
  
  // Notification & Status
  status: [
    'Notifications', 'NotificationImportant', 'NotificationsOff', 'Warning',
    'Error', 'CheckCircle', 'Cancel', 'Info', 'Help', 'HelpOutline',
    'Lightbulb', 'LightbulbOutline', 'Star', 'StarBorder', 'Bookmark', 'BookmarkBorder'
  ],
  
  // Time & Calendar
  time: [
    'Schedule', 'AccessTime', 'Timer', 'Alarm', 'AlarmOn', 'AlarmOff', 'Snooze',
    'Today', 'DateRange', 'Event', 'EventAvailable', 'CalendarToday',
    'History', 'Update', 'RestoreFromTrash', 'WatchLater'
  ]
};
