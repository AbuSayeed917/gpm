  ...
  const services = [
    {
      ...
      description: 'Comprehensive payroll migration services tailored for small and medium enterprises with seamless integration capabilities.',
      features: [
    ...
    },
    {
      ...
      description: 'Enterprise-grade payroll migration for large organizations with complex multi-country requirements and advanced compliance needs.',
      features: [
    ...
    },
    {
      ...
      description: 'Strategic payroll consultancy services including process optimization, compliance review, and migration planning expertise.',
      features: [
        'Strategy & Planning',
        'Risk Assessment',
        'Compliance Review',
      ...
      <div className="apple-container">
        ...
        >
          ...
          <p className="apple-section-subtitle">
            Tailored payroll migration solutions for every business size and complexity. 
            Zero downtime guaranteed with our proven methodologies.
          </p>
        </motion.div>
        ...
        >
          {services.map((service, index) => (
            ...
            >
              {index === 1 && (
                <div className="apple-service-badge">Most Popular</div>
              )}
              
              <div className="apple-service-header">
                <div 
                  className="apple-service-icon"
                ...
                <ul className="apple-service-features-list">
                  {service.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="apple-service-feature">
                      <svg className="apple-service-check" viewBox="0 0 20 20" width="20" height="20">
              ...
              <div className="apple-service-actions">
                <Link to={service.path} className="apple-button apple-button-primary apple-button-large">
                  Learn More
                </Link>
                <Link to="/quote" className="apple-button apple-button-secondary apple-button-large">
                  Get Quote
                </Link>
              </div>
            </motion.div>
