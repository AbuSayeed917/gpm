        ...
        <div className="apple-testimonials-container">
          <div className="apple-testimonials-main">
            <AnimatePresence mode="wait">
              ...
              >
                <div className="apple-testimonial-content">
                  ...
                  <p className="apple-testimonial-text">
                ...
                <div className="apple-testimonial-author">
                  ...
                  <div className="apple-testimonial-info">
                    ...
                    <div className="apple-testimonial-company">{testimonials[activeIndex].company}</div>
                    <div className="apple-testimonial-meta">
                      <span className="apple-testimonial-type">{testimonials[activeIndex].companyType}</span>
                      <span className="apple-testimonial-separator">•</span>
                      <span className="apple-testimonial-employees">{testimonials[activeIndex].employeeCount} employees</span>
                    </div>
                  </div>
                </div>
            ...
            <div className="apple-testimonials-controls">
              <button className="apple-testimonial-nav apple-testimonial-prev" onClick={prevTestimonial}>
              ...
              <button className="apple-testimonial-nav apple-testimonial-next" onClick={nextTestimonial}>
                <svg viewBox="0 0 24 24" width="20" height="20">
