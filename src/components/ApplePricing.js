  ...
  const pricingPlans = [
    {
      ...
      period: 'per project',
      description:
        'Complete payroll migration solution for growing businesses with up to 500 employees.',
      features: [
    ...
    },
    {
      ...
      period: 'per project',
      description:
        'Comprehensive enterprise-grade migration with advanced compliance and multi-country support.',
      features: [
    ...
    },
    {
      ...
      period: 'per hour',
      description:
        'Expert consultation for payroll strategy, compliance review, and migration planning.',
      features: [
      ...
      <div className='apple-container'>
        ...
        >
          ...
          <p className='apple-section-subtitle'>
            Choose the right migration solution for your business. All plans include our zero
            downtime guarantee and dedicated expert support throughout the process.
          </p>
        </motion.div>
        ...
        >
          {pricingPlans.map((plan) => (
            ...
            >
              {plan.popular && <div className='apple-pricing-badge'>Most Popular</div>}
              ...
              <div className='apple-pricing-description'>{plan.description}</div>
        ...
        >
          ...
          <div className='apple-pricing-faq-grid'>
            <div className='apple-pricing-faq-item'>
              ...
              <p>
                All our prices include complete migration, testing, validation, training, and
                post-migration support. No hidden fees.
              </p>
            </div>
            ...
            <div className='apple-pricing-faq-item'>
              ...
              <p>
                We use parallel migration techniques and comprehensive testing environments to
                ensure your payroll remains operational throughout the process.
              </p>
            </div>
            ...
            <div className='apple-pricing-faq-item'>
              ...
              <p>
                We maintain complete rollback capabilities and provide instant support. Our
                guarantee covers any issues that may arise during migration.
              </p>
            </div>
            ...
            <div className='apple-pricing-faq-item'>
              ...
              <p>
                Yes, we can create bespoke migration solutions for unique requirements. Contact us
