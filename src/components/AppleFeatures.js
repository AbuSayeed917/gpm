  ...
  const features = [
    {
      ...
      description:
        'Our proven migration methodology ensures your payroll system stays operational throughout the entire migration process.',
    ...
    },
    {
      ...
      description:
        'Stay compliant across all jurisdictions with our comprehensive understanding of international payroll regulations.',
    ...
    },
    {
      ...
      description:
        'Advanced automation tools and optimized processes ensure the fastest possible migration times in the industry.',
    ...
    },
    {
      ...
      description:
        'Your sensitive payroll data is protected with military-grade encryption and security protocols.',
    ...
    },
    {
      ...
      description:
        'Dedicated migration specialists guide you through every step with personalized support and expertise.',
    ...
    },
    {
      ...
      description:
        'Comprehensive reporting and analytics to track migration progress and validate data accuracy.',
      ...
      <div className='apple-container'>
        ...
        >
          ...
          <p className='apple-section-subtitle'>
            Our comprehensive approach ensures successful payroll migrations with zero business
            disruption. Trusted by industry leaders worldwide.
          </p>
        </motion.div>
        ...
        <div className='apple-features-grid'>
          {features.map((feature, index) => (
            ...
            >
              <div className='apple-feature-icon' style={{ '--feature-color': feature.color }}>
