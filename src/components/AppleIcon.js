...
export const AppleIconGallery = ({ 
  ...
  const popularIcons = [
    'Home', 'Search', 'Settings', 'Person', 'Notifications', 'Mail', 'Phone',
    'Message', 'Camera', 'Photo', 'Video', 'Music', 'Download', 'Upload',
    'Share', 'Favorite', 'Star', 'Bookmark', 'Add', 'Remove', 'Edit', 'Delete',
    'ArrowForward', 'ArrowBack', 'ArrowUpward', 'ArrowDownward', 'Close',
    'Menu', 'MoreHoriz', 'MoreVert', 'Check', 'Clear', 'Refresh', 'Sync',
    'Cloud', 'CloudDownload', 'CloudUpload', 'Folder', 'FolderOpen', 'Insert',
    'AttachFile', 'Link', 'Print', 'Save', 'Security', 'Visibility', 'Lock',
    'LockOpen', 'AccountCircle', 'Dashboard', 'Timeline', 'TrendingUp', 'Analytics'
  ];
