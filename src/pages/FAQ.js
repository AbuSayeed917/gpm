...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        'Currently, we specialise in payroll system migrations and implementations. However, we can collaborate with your HRIS vendor or partner to ensure smooth data flow and integration between payroll and HR systems. We coordinate closely with HR system specialists to ensure seamless connectivity and data synchronization.',
    },
    {
      category: 'Data',
      question: 'What if our data is messy or incomplete?',
      answer:
        "That's common — and something we're very comfortable handling. We perform full data cleansing, formatting, and validation as part of every migration project. Our process includes data profiling, quality assessment, cleansing procedures, validation rules, and comprehensive testing to ensure data integrity throughout the migration.",
    },
    {
      category: 'Compliance',
      question: 'Can you help us stay compliant with local laws during migration?',
      answer:
        'Yes. We are well-versed in country-specific compliance across Europe and the Middle East — from RTI and NI in the UK to Lohnsteuer and Sozialversicherung in Germany. Our team stays current with regulatory changes, ensures statutory reporting continuity, and implements compliance controls in the new system from day one.',
    },
    {
      category: 'Business Size',
      question: 'Do you work with SMEs as well as large enterprises?',
      answer:
        "Yes. Whether you're a small care provider or a global tech firm, we tailor our services to match your scale, complexity, and budget. We have specialized approaches for SMEs (streamlined processes, cost-effective solutions) and enterprises (complex integrations, multi-country support, extensive testing phases).",
    },
    {
      category: 'Vendors',
      question: 'Can you work directly with our software vendors or payroll providers?',
      answer:
        'Yes. We regularly collaborate with third-party vendors, including Dayforce, Sage, ADP, and local payroll providers to ensure smooth data handover, testing, and integration. We coordinate technical requirements, manage vendor communications, and ensure all parties are aligned throughout the migration process.',
    },
    {
      category: 'Security',
      question: 'Do you sign NDAs or offer data protection agreements?',
      answer:
        'Absolutely. We follow GDPR and local data privacy laws strictly. NDAs, DPAs, and confidentiality agreements are standard in our onboarding process. We implement comprehensive security measures including encrypted data transfer, secure access controls, audit trails, and compliance with ISO 27001 standards.',
    },
    {
      category: 'Business Case',
      question: 'Can you help build a business case for payroll system change?',
      answer:
        'Yes. We offer strategic payroll consultancy to help you assess ROI, identify current system gaps, and prepare cost/benefit documentation for internal approvals. This includes efficiency analysis, cost comparison, risk assessment, compliance evaluation, and projected benefits calculation.',
    },
    {
      category: 'Documentation',
      question: 'What kind of documentation do we receive after go-live?',
      answer:
        "You'll receive SOPs (standard operating procedures), system configuration documents, user guides, troubleshooting manuals, and handover guides so your team can confidently manage post-migration payroll. All documentation is customized to your specific setup and includes step-by-step processes for common tasks.",
    },
    {
      category: 'Training',
      question: 'Can you train our internal payroll or HR teams?',
      answer:
        'Yes. We offer tailored training and knowledge transfer sessions to ensure your in-house team is fully equipped to manage the new system independently. Training covers system navigation, daily operations, month-end procedures, reporting, troubleshooting, and administrative functions.',
    },
    {
      category: 'Support',
      question: 'What if we need help after the project is completed?',
      answer:
        'We offer post-go-live support and optional ongoing consultancy. You can choose from hourly support, weekly check-ins, monthly maintenance, or project-based support models based on your needs. Support includes issue resolution, system optimization, regulatory updates, and enhancement guidance.',
    },
    {
      category: 'Pricing',
      question: 'Do you offer fixed-price packages or flexible pricing?',
      answer:
        'We provide both. For many migrations, we offer fixed-scope pricing with clear deliverables and timelines. We also support flexible project-based or retainer models for more complex, evolving needs. Pricing depends on scope, complexity, timeline, and support requirements. We provide detailed quotes after initial assessment.',
    },
  ];
  ...
  const quickStats = [
    {
      ...
      description: 'From SME to enterprise projects',
    },
            ...
            >
              ...
              >
                ...
                <span
                  style={{
                    background:
                      'linear-gradient(90deg, var(--color-primary-500) 0%, var(--color-primary-400) 100%)',
                    backgroundClip: 'text',
              ...
              >
                Everything you need to know about our payroll migration services, process, and
                approach. Get clear answers from our experts who have successfully completed 500+
                migrations.
              </motion.p>
              ...
              >
                  ...
                  <input
                    ...
                    onFocus={(e) => {
                      ...
                      e.target.style.boxShadow =
                        '0 8px 32px rgba(0, 191, 255, 0.25), 0 0 0 4px rgba(0, 191, 255, 0.1)';
                    }}
                    onBlur={(e) => {
                ...
                {searchTerm && (
                  ...
                  >
                    {filteredFAQs.length} result{filteredFAQs.length !== 1 ? 's' : ''} found for "
                    {searchTerm}"
                  </motion.p>
                )}
              </motion.div>
              ...
              {filteredFAQs.map((faq, index) => (
                ...
                >
                  <motion.button
                    ...
                    whileHover={{
                      backgroundColor: openFAQ === index ? '#f0f9ff' : 'rgba(0, 122, 255, 0.02)',
                    }}
                  >
                    <div
                      style={{
              ...
              <div className='cta-section'>
                <div className='cta-content'>
                  ...
                  <p className='text-inverse text-lg' style={{ marginBottom: 'var(--space-6)' }}>
                    Our payroll migration experts are here to help. Get personalized answers to your
