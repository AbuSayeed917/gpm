          ...
          >
            <div className="card p-8 lg:p-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="input-field">
                  <label htmlFor="currentSystem" className="label">Current Payroll System</label>
                  <input
                    type="text"
                    id="currentSystem"
                    name="currentSystem"
                ...
                <div className="input-field">
                  <label htmlFor="targetSystem" className="label">Target System (if known)</label>
                  <input
                    type="text"
                    id="targetSystem"
                    name="targetSystem"
                ...
                <div className="input-field">
                  <label htmlFor="countries" className="label">Countries/Regions</label>
                  <input
                    type="text"
                    id="countries"
                    name="countries"
                ...
                <div className="input-field">
                  <label htmlFor="details" className="label">Additional Details</label>
                  <textarea
                    id="details"
                    name="details"
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
                  <button type="submit" className="btn-primary flex items-center justify-center gap-3 px-8 py-4">
                    <Send sx={{ fontSize: 20 }} />
                    Send Request
                  </button>
                  <button type="button" className="btn-outlined flex items-center justify-center gap-3 px-8 py-4">
