  ...
  const stories = [
    {
      ...
      avatar: 'SH',
      challenge:
        'Growing demand for payroll migration services from clients, but lacked in-house technical expertise and resources to deliver comprehensive solutions.',
      solution:
        'Partnered with our white-label migration services to offer complete payroll transformation solutions under their brand, with full technical support.',
      results: [
      ...
      quote:
        'This partnership transformed our practice. We can now offer enterprise-grade payroll migrations while focusing on what we do best - strategic HR consulting.',
      testimonial: {
    ...
    },
    {
      ...
      avatar: 'DF',
      challenge:
        "Existing payroll system couldn't scale with rapid business growth, causing processing delays and compliance issues affecting client trust.",
      solution:
        'Strategic payroll optimization and phased system enhancement without full migration, focusing on process improvement and automation.',
      results: [
      ...
      quote:
        'The consultancy approach was perfect for our needs. We got the improvements we needed without the disruption of a full migration.',
      testimonial: {
        name: 'Andrew MacLeod',
    ...
    },
    {
      ...
      avatar: 'GC',
      challenge:
        'Complex contractor and employee payment structures across multiple projects required specialized expertise for optimization and compliance.',
      solution:
        'Comprehensive payroll audit, process reengineering, and implementation of best practices for multi-tier workforce management.',
      results: [
      ...
      quote:
        'The strategic insights and process improvements delivered immediate value. Our payroll operations now support our growth ambitions perfectly.',
      testimonial: {
  ...
  const benefits = [
    {
      ...
      description:
        'Deep payroll and HR expertise combined with strategic business insights to optimize operations without full migration.',
    },
    {
      icon: <Support sx={{ fontSize: 40, color: 'var(--color-primary)' }} />,
      title: 'Flexible Engagement',
      description:
        'Tailored consultancy packages from quick assessments to comprehensive transformation programs based on your needs.',
    },
    {
      icon: <Analytics sx={{ fontSize: 40, color: 'var(--color-primary)' }} />,
      title: 'Risk-Free Approach',
      description:
        'Optimize and improve existing systems with minimal disruption while maximizing efficiency and compliance.',
    },
    {
      icon: <Handshake sx={{ fontSize: 40, color: 'var(--color-primary)' }} />,
      title: 'Partnership Model',
      description:
        'White-label services for consultants and solution providers to expand their portfolio with our technical expertise.',
    },
  ];
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Real results from our consultancy services - from strategic partnerships to process
              optimization.
            </motion.p>
                  ...
                  <div>
                    ...
                    <div
                      style={{
                        ...
                        borderRadius: '16px',
                        background:
                          'linear-gradient(135deg, rgba(255, 149, 0, 0.05) 0%, rgba(175, 82, 222, 0.05) 100%)',
                        border: '1px solid rgba(255, 149, 0, 0.1)',
                      }}
                    >
                      <blockquote
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Get expert guidance to optimize your payroll operations without full migration
              disruption. Our consultancy services deliver immediate value and long-term strategic
              advantage.
            </p>
